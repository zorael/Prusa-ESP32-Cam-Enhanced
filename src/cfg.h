...
public:
  ...
  void SavePrusaLinkEnable(bool);
  void SavePrusaLinkIp(String);
  void SavePrusaLinkApiKey(String);
  void SaveTlTriggerMode(uint8_t);
  void     SaveTlWasRecording(bool);
  void     SaveTlSegmentCount(uint16_t);
  void     SaveTlMaxFrames(uint16_t);
  void     SaveUploadEnable(bool);
  void     SavePlStopUploadOnDone(bool);
  void     SaveTlFrameMode(uint8_t);
  ...
  bool LoadPrusaLinkEnable();
  String LoadPrusaLinkIp();
  String LoadPrusaLinkApiKey();
  uint8_t  LoadTlTriggerMode();
  bool     LoadTlWasRecording();
  uint16_t LoadTlSegmentCount();
  uint16_t LoadTlMaxFrames();
  bool     LoadUploadEnable();
  bool     LoadPlStopUploadOnDone();
  uint8_t  LoadTlFrameMode();
